...
def addDir2(name,url,mode,iconimage):
        ...
        return ok
if active =="True":
 SOURCES = [{"url": "http://dexteriptv.com/dev2/dex.php?username=%s&password=%s"%(usern,passw), "fanart": "http://dexteriptv.com/live/thumbs/fanart.jpg", "genre": "Tv Live", "date": "01.09.2015", "credits": "DexterTV", "thumbnail": "http://1.bp.blogspot.com/-USW8oQI2iPA/T-FssXUqJ-I/AAAAAAAAAIU/eqk5G_L5fRY/s1600/dexter.png"}]
else:
 SOURCES = [{"url": "http://dexteriptv.com/", "fanart": "http://dexteriptv.com/live/thumbs/fanart.jpg", "genre": "Tv Live", "date": "01.09.2015", "credits": "DexterTV", "thumbnail": "http://1.bp.blogspot.com/-USW8oQI2iPA/T-FssXUqJ-I/AAAAAAAAAIU/eqk5G_L5fRY/s1600/dexter.png"}]
 ...
 addDir('[COLOR blueviolet][B]Signup For A Free Account[/COLOR][/B]','http://50.7.136.90/signup.php?username=%s&password=%s'%(usern,passw),29,'http://icons.iconarchive.com/icons/scoyo/badge/256/Signup-icon.png')
...
def SIGNUP():
    ...
    if dialog.yesno("Free Signup", 'Do you Wish To Sign UP','', "",'Cancel','Sign UP'):
        ...
        xbmc.executebuiltin('Container.Refresh')
        signup=urllib2.urlopen('http://50.7.136.90/signup.php?username=%s&password=%s'%(email,password)).read()
        if signup == 'OK':
            xbmc.executebuiltin('Container.Refresh')
            dialog.ok("Success!", "Your account has been created please login! Your account will be validated and if found invalid will be banned along with your IP!")
            addon.setSetting('active','True')
            xbmc.executebuiltin('Container.Refresh')
            return
        elif signup =='duplicate':
            xbmc.executebuiltin('Container.Refresh')
            dialog.ok("Sorry!", "Our records detect this is a duplicate account a fix was ran on this account we will now try to sign you in.")
            addon.setSetting('active','True')
            xbmc.executebuiltin('Container.Refresh')
            return
        elif signup =='Nonpass':
